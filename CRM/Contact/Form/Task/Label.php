...
class CRM_Contact_Form_Task_Label extends CRM_Contact_Form_Task {
  ...
  public function postProcess() {
    ...
    if (!empty($fv['location_type_id'])) {
      ...
      $primaryLocationOnly = FALSE; // ALAIN
    }
    else {
      $returnProperties = array_merge($returnProperties, $address);
      $primaryLocationOnly = TRUE; // ALAIN
    }
...
$details = $query->apiQuery($params, $returnProperties, NULL, NULL, 0, $numberofContacts, TRUE, FALSE, TRUE, CRM_Contact_BAO_Query::MODE_CONTACTS, NULL, $primaryLocationOnly); // ALAIN
